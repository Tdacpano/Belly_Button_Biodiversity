...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var b_labels = sampleResult.otu_labels;
    var b_values = sampleResult.sample_values;
    ...
    var gaugeArray =  gaugedata.filter(metaObj => metaObj.id == sample);
